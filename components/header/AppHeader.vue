    ...
    <header>
        <b-navbar toggleable="lg">
            ...
            <b-collapse id="navbar-toggle-collapse" class="ml-auto justify-content-end" is-nav>
                <b-navbar-nav class="align-items-center">
                    <b-nav-item active-class="active" :to="localePath('/')" exact>Home</b-nav-item>
                    <b-nav-item active-class="active" :to="localePath('about')">About</b-nav-item>
                    <b-nav-item active-class="active" :to="localePath('services')">Solutions</b-nav-item>
                    <b-nav-item active-class="active" :to="localePath('/testimonials')">Insight</b-nav-item>
                    <b-nav-item active-class="active" :to="localePath('/blogs')">News</b-nav-item>
                    <b-nav-item class="m-0">
                        <a href="#" class="btn">Get started</a>
                    </b-nav-item>
                    <langSwitch></langSwitch>
                    <b-nav-item class="m-0" @click="side = !side">
                        <font-awesome-icon class="d-lg-block d-none"  icon="fa-solid fa-plus" />
        ...
        <div :class="side ? 'opend' : '' " class="side-bar">
            <div class="content-wrapper">
                ...
                <div class="widge">
                    <img class="img-fluid" src="https://avada.theme-fusion.com/information-technology/wp-content/uploads/sites/81/2016/11/cloud-2-300x216.png" alt="">
                </div>
