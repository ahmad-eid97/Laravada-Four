...
<style lang="scss">
    ...
    .features  .feature-inner ul{
        list-style: none;
        padding: 0;
    }
    .features  .feature-inner ul li{
        color: rgb(255, 255, 255);
        font-family: Roboto;
        font-size: 16px;
        font-weight: 400;
    ...
    .features  .feature-inner ul li svg{
        margin-right: 12px;
    }
    .features .box {
        margin-bottom: 40px;
    ...
    .features .box .icon{
        ...
        border-radius: 50%;
        padding: 6px;
        border: 2px solid rgb(116, 197, 218);
        position: relative;
    ...
    .features .box:hover .icon{
        ...
        border: 2px solid rgb(98, 57, 189);
